...
public class Controller {
    ...
    public ResponseEntity<String> storeFile(@RequestBody InputData inputData) throws IOException {
        String fileName = inputData.getFile();
        String inputDataToFile = inputData.getData();
        System.out.println(inputDataToFile);
        // Temp line
        return ResponseEntity.ok().contentType(MediaType.APPLICATION_JSON).body(FileOperations.storeDataToFile(fileName, inputDataToFile));
    }
}